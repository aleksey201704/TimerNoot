...
//--------------- Загружаем форму --------------//
	...
	private: System::Void MyForm_Load(System::Object^ sender, System::EventArgs^ e) {
		...
		TCounterRestS = 0; // Счтечик отдыха устанволенн
		TCounterRestM = 0; // Счтечик отдыха устанволенн
	...
	private: System::Void TimerMin_Tick(System::Object^ sender, System::EventArgs^ e) {
		...
		if (TCounterRestM == 1) // Установили Время для отдыха минуты
		{
			TimerMin->Stop();
			TimerCounterM = 0;
			TimerCounterS = 0;
...
private: System::Void btnRest_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	TimerCounterS = 0;
	TimerCounterM = 0;
	TCounterRestS = 20; // Установили время от кнопки
	TCounterRestM = 1;
